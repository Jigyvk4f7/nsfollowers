...
class Ns_Followers:
    def __init__(self):
        ...
        self.__userid='66445092003' #Enter UserID Here
        self.__username='gardners7t' #Enter UserName Here
        self._session='66445092003:pNjgVlSwgfH6qR:26:AYfXDtxrPDGxf0EuzgRAjvzFpxbwMCMyLfkdUYmGnQ' #Enter SessionID Here
